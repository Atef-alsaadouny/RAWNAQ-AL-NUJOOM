...
class UpdateAppointmentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'status' => 'required|in:' . implode(',', [Appointment::STATUS_PENDING, Appointment::STATUS_ASSIGNED, Appointment::STATUS_IN_PROGRESS, Appointment::STATUS_COMPLETED, Appointment::STATUS_CANCELLED]),
        ];
    }
