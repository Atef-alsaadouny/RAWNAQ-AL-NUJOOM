<?php $__env->startSection('title', __('site_name') . ' — ' . __('Gallery')); ?>
<?php $__env->startSection('meta_description', __('See photos of alnjoom salon — a tour of the salon atmosphere, our work, and services in Kuwait.')); ?>
...
<div class="max-w-7xl mx-auto px-4">
    ...
    <div class="text-center mb-12">
        ...
        <h1 class="text-4xl font-bold text-gray-800 mb-3"><?php echo e(__('Gallery')); ?></h1>
        <p class="text-gray-500 text-lg max-w-2xl mx-auto"><?php echo e(__("See for yourself — a tour of the salon and some of our work")); ?></p>
    </div>
    ...
    <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
        ...
        <div class="group relative overflow-hidden rounded-[2rem] shadow-sm border border-rose-100/60 aspect-square cursor-pointer hover:shadow-xl hover:-translate-y-1 transition-all duration-500 bg-gradient-to-br from-rose-100 to-amber-50 flex items-center justify-center"
             onclick="openModal('<?php echo e($img['src']); ?>', '<?php echo e($img['title']); ?>')">
            <span class="text-6xl opacity-20 group-hover:opacity-30 transition-opacity duration-300 select-none"><?php echo e($img['emoji']); ?></span>
...
<div id="imageModal" class="fixed inset-0 z-[200] bg-black/80 backdrop-blur-sm hidden items-center justify-center p-4" onclick="closeModal(event)">
    <div class="relative max-w-3xl w-full" onclick="event.stopPropagation()">
        <button onclick="closeModal()" class="absolute -top-12 right-0 text-white/70 hover:text-white text-sm font-bold transition-colors"><?php echo e(__('Close')); ?> ✕</button>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/gallery.blade.php ENDPATH**/ ?>