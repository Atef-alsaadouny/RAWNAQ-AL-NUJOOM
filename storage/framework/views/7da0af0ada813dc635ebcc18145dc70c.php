...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', __('Employee').' - '.__('site_name')); ?></title>
...
<div class="flex h-screen">
    ...
    <aside id="sidebar" class="fixed md:relative w-64 bg-white shadow-lg z-40 h-full transition-all duration-300 md:translate-x-0 flex flex-col">
        <div class="p-5 border-b border-gray-100 flex items-center justify-between">
            <a href="<?php echo e(route('employee.dashboard')); ?>" class="flex items-center gap-1.5">
                <picture>
        ...
        <nav class="flex-1 p-3 space-y-0.5 overflow-y-auto">
            <a href="<?php echo e(route('employee.dashboard')); ?>" class="group flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 <?php echo e(request()->routeIs('employee.dashboard') ? 'bg-blue-50 text-blue-700' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'); ?>">
            ...
            <a href="<?php echo e(route('employee.appointments')); ?>" class="group flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 <?php echo e(request()->routeIs('employee.appointments.*') ? 'bg-blue-50 text-blue-700' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'); ?>">
                ...
                <span><?php echo e(__('My Bookings')); ?></span>
            </a>
            <a href="<?php echo e(route('employee.available')); ?>" class="group flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 <?php echo e(request()->routeIs('employee.available') ? 'bg-blue-50 text-blue-700' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'); ?>">
                <svg class="w-5 h-5 shrink-0 <?php echo e(request()->routeIs('employee.available') ? 'text-blue-500' : 'text-gray-400 group-hover:text-gray-600'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                <span><?php echo e(__('Available Bookings')); ?></span>
            </a>
            <a href="<?php echo e(route('employee.ratings')); ?>" class="group flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 <?php echo e(request()->routeIs('employee.ratings') ? 'bg-blue-50 text-blue-700' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'); ?>">
                ...
                <span><?php echo e(__('My Ratings')); ?></span>
            </a>
        ...
        <header class="bg-white shadow-sm p-4">
            <div class="flex justify-between items-center">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <button id="notifBellBtn" onclick="toggleNotifPanel()" class="relative text-gray-500 hover:text-blue-600 transition-colors" title="<?php echo e(__('New Bookings')); ?>">
            ...
            <div id="notifList" class="overflow-y-auto" style="max-height: calc(100vh - 190px);">
                <div class="flex items-center justify-center py-12 text-gray-400">
                    <div class="text-center">
                        ...
                        <p class="text-sm"><?php echo e(__('No new bookings')); ?></p>
                    </div>
                </div>
            </div>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
        ...
        item.innerHTML =
            '<div class="flex items-start gap-3">' +
                ...
                '<div class="flex-1 min-w-0">' +
                    ...
                    '</div>' +
                '</div>' +
                '<a href="#" class="shrink-0 text-blue-600 hover:text-blue-700 bg-blue-50 hover:bg-blue-100 rounded-lg px-2.5 py-1.5 text-xs font-medium transition-colors" data-notif="link"><?php echo e(__("View")); ?></a>' +
            '</div>';
    ...
    function pollNotifications() {
        fetch('<?php echo e(route("employee.notifications.recent")); ?>?since=' + encodeURIComponent(notifSeenTime), {
...
<?php /**PATH /var/www/html/resources/views/layouts/employee.blade.php ENDPATH**/ ?>