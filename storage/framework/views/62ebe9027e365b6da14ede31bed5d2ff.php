...
<div class="max-w-2xl mx-auto px-4 py-6">
    <div class="text-center mb-8">
        ...
        <p class="text-gray-500 mt-1.5"><?php echo e(__('Ticket number')); ?>: <strong class="text-rose-600"><?php echo e($appointment->ticket_number); ?></strong></p>
    </div>

    <div class="bg-white/90 backdrop-blur-sm rounded-[2.5rem] shadow-xl shadow-rose-200/40 border border-rose-100/50 p-5 md:p-10">
        <form method="POST" action="<?php echo e(route('customer.appointment.update', $appointment)); ?>" id="editForm">
            <?php echo csrf_field(); ?>
            ...
            <div class="mb-8">
                <div class="flex items-center gap-2 mb-1">
                    <svg class="w-5 h-5 text-rose-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/></svg>
...
<?php echo $__env->make('layouts.customer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/customer/edit.blade.php ENDPATH**/ ?>