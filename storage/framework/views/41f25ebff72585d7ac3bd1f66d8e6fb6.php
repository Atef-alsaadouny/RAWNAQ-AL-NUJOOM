...
<?php $__env->startSection('title', __('site_name')); ?>
...
<div class="max-w-7xl mx-auto px-4">
    ...
    <div class="text-center py-20 bg-gradient-to-b from-rose-50 via-white to-amber-50 rounded-[2.5rem] mx-4 shadow-sm border border-rose-100/50">
        <div class="inline-flex items-center gap-2 bg-rose-100/60 text-rose-700 px-5 py-2 rounded-full text-sm font-medium mb-6">
            ...
            <?php echo e(__("Luxury Ladies Salon")); ?>

        </div>
        <h1 class="text-4xl font-bold text-gray-800 mb-4 leading-tight"><?php echo e(__('Welcome to')); ?> <span class="text-transparent bg-clip-text bg-gradient-to-l from-amber-600 to-rose-500"><?php echo e(__('site_name')); ?></span></h1>
        <p class="text-xl text-gray-500 max-w-2xl mx-auto leading-relaxed">
            <?php echo e(__("Experience the best personal care services in a luxurious atmosphere")); ?>
    ...
    <div class="mt-8 mx-4">
        <div class="bg-white rounded-2xl shadow-sm border border-rose-100/60 p-4 md:p-5 flex items-center justify-between gap-4 hover:shadow-md hover:-translate-y-0.5 transition-all duration-300">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <p class="text-xs text-rose-400 font-medium"><?php echo e(__('Upcoming Appointment')); ?></p>
                    <?php
                    ...
                    ?>
                    <p class="font-bold text-gray-800"><?php echo e($dayName); ?> <?php echo e($upcomingAppointment->appointment_date->format('Y-m-d')); ?> — <?php echo e($upcomingAppointment->shift === Appointment::SHIFT_MORNING ? __('Morning') : __('Evening')); ?></p>
                    <p class="text-sm text-gray-500 mt-0.5">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($upcomingAppointment->display_services): ?>
                            <?php echo e($upcomingAppointment->display_services); ?>
    ...
    <div class="mt-16 bg-white rounded-[2.5rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-rose-100/60 overflow-hidden">
        <div class="grid md:grid-cols-2">
            <div class="p-12 flex flex-col justify-center order-2 md:order-1">
                ...
                <h2 class="text-3xl font-bold text-gray-800 mb-4"><?php echo e(__('About')); ?> <?php echo e(__('site_name')); ?></h2>
                <p class="text-gray-500 leading-relaxed mb-8 text-[15px]">
                    <?php echo e(__("alnjoom is a specialized salon offering personal care services with the highest quality standards")); ?>.
                    <?php echo e(__("Our experienced professional team ensures a distinctive experience and complete comfort")); ?>.
                    <?php echo e(__("We use the best global products to guarantee the best results for our valued clients")); ?>.
                </p>
                <div class="space-y-4">
                    <div class="flex items-start gap-4 p-4 bg-rose-50/50 rounded-xl">
                        ...
                        <div>
                            <p class="font-medium text-gray-700 text-sm"><?php echo e(__('Working Hours')); ?></p>
                            <p class="text-gray-500 text-sm"><?php echo e(__('Sat - Thu: 10:00 AM - 10:00 PM')); ?></p>
                            <p class="text-gray-500 text-sm"><?php echo e(__('Fri: 1:00 PM - 8:00 PM')); ?></p>
                        </div>
                    </div>
                    <div class="flex items-center gap-4 p-4 bg-amber-50/50 rounded-xl">
                        ...
                        <div>
                            <p class="font-medium text-gray-700 text-sm"><?php echo e(__('Location')); ?></p>
                            <p class="text-gray-500 text-sm"><?php echo e(__("Kuwait — Salmiya, Arabian Gulf Street")); ?></p>
                        </div>
                    </div>
                    <div class="flex items-center gap-4 p-4 bg-rose-50/50 rounded-xl">
                        ...
                        <div>
                            <p class="font-medium text-gray-700 text-sm"><?php echo e(__('Phone')); ?></p>
            ...
            <div class="bg-gradient-to-br from-rose-100 via-rose-50 to-amber-50 p-12 flex items-center justify-center order-1 md:order-2 min-h-[300px]">
                <div class="text-center">
                    ...
                    <p class="text-rose-800 font-bold text-lg"><?php echo e(__("Your ideal place for personal care")); ?></p>
                    <p class="text-rose-500 text-sm mt-2"><?php echo e(__("Combine beauty and relaxation")); ?></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="mt-16 py-16 px-8 bg-gradient-to-br from-rose-500 via-rose-600 to-amber-700 rounded-[2.5rem] text-center text-white shadow-xl shadow-rose-200/50">
        <div class="inline-flex items-center gap-2 bg-white/10 backdrop-blur text-white/90 px-5 py-2 rounded-full text-sm font-medium mb-4 border border-white/20">
            ✨ <?php echo e(__('Exclusive Benefits')); ?>

        </div>
        <h2 class="text-3xl font-bold mb-3"><?php echo e(__('Why Register?')); ?></h2>
        <p class="text-rose-100 text-lg mb-12"><?php echo e(__("Create your account and enjoy exclusive benefits")); ?></p>
        ...
        <div class="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-8 text-center border border-white/20 hover:bg-white/20 transition-all duration-300">
                ...
                <h3 class="text-lg font-bold mb-2"><?php echo e(__('Your Previous Bookings')); ?></h3>
                <p class="text-rose-100 text-sm leading-relaxed"><?php echo e(__("See all your bookings in one place without needing a ticket number")); ?></p>
            </div>
            ...
            <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-8 text-center border border-white/20 hover:bg-white/20 transition-all duration-300">
                ...
                <h3 class="text-lg font-bold mb-2"><?php echo e(__('Repeat Booking with One Click')); ?></h3>
                <p class="text-rose-100 text-sm leading-relaxed"><?php echo e(__("Want to book the same service again? Repeat your previous booking with one click")); ?></p>
            </div>
            ...
            <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-8 text-center border border-white/20 hover:bg-white/20 transition-all duration-300">
                ...
                <h3 class="text-lg font-bold mb-2"><?php echo e(__('Rate Services')); ?></h3>
                    <p class="text-rose-100 text-sm leading-relaxed"><?php echo e(__("After the service, rate your experience and help others choose")); ?></p>
            </div>
        </div>
        ...
        <div class="mt-12">
            <p class="text-rose-100 mb-8 text-lg"><?php echo e(__('Start Now')); ?>:</p>
            <div class="flex justify-center gap-4 flex-wrap">
                ...
                <a href="<?php echo e(route('login')); ?>"
                   class="bg-rose-400 text-white border-2 border-white/30 px-8 py-4 rounded-xl text-lg font-bold hover:bg-rose-300 hover:-translate-y-0.5 transition-all duration-200">
                    <?php echo e(__("I have an account — Login")); ?>
    ...
    <div class="mt-16 mb-16">
        <div class="text-center mb-12">
            ...
            <h2 class="text-3xl font-bold text-gray-800 mt-4"><?php echo e(__('Booking in 3 Simple Steps')); ?></h2>
            <p class="text-gray-500 mt-2 max-w-xl mx-auto"><?php echo e(__('From choosing the service to enjoying your experience, we make it easy')); ?></p>
        </div>
        ...
        <div class="grid md:grid-cols-3 gap-6">
            <div class="bg-white p-8 rounded-[1.75rem] shadow-[0_4px_20px_rgb(0,0,0,0.03)] border border-rose-100/60 text-center group hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] hover:-translate-y-0.5 transition-all duration-300">
                ...
                <h3 class="text-lg font-bold text-gray-800"><?php echo e(__('Choose Your Service')); ?></h3>
                <p class="text-gray-400 text-sm mt-2 leading-relaxed"><?php echo e(__('Browse our services and pick what suits you best')); ?></p>
            </div>
            ...
            <div class="bg-white p-8 rounded-[1.75rem] shadow-[0_4px_20px_rgb(0,0,0,0.03)] border border-rose-100/60 text-center group hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] hover:-translate-y-0.5 transition-all duration-300">
                ...
                <h3 class="text-lg font-bold text-gray-800"><?php echo e(__('Pick Your Time')); ?></h3>
                <p class="text-gray-400 text-sm mt-2 leading-relaxed"><?php echo e(__('Choose a convenient date and time for your appointment')); ?></p>
            </div>
            ...
            <div class="bg-white p-8 rounded-[1.75rem] shadow-[0_4px_20px_rgb(0,0,0,0.03)] border border-rose-100/60 text-center group hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] hover:-translate-y-0.5 transition-all duration-300">
                ...
                <h3 class="text-lg font-bold text-gray-800"><?php echo e(__('Enjoy Your Experience')); ?></h3>
                <p class="text-gray-400 text-sm mt-2 leading-relaxed"><?php echo e(__('Visit us and let our team take care of you')); ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="mt-16 mb-16">
        <div class="text-center mb-10">
            <div class="inline-flex items-center gap-2 bg-rose-100/60 text-rose-700 px-5 py-2 rounded-full text-sm font-medium mb-4">
                📸 <?php echo e(__('Salon Tour')); ?>

            </div>
            <h2 class="text-3xl font-bold text-gray-800 mb-3"><?php echo e(__('Gallery')); ?></h2>
            <p class="text-gray-500 max-w-xl mx-auto"><?php echo e(__("A quick look at our salon and some of our work")); ?></p>
        </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $homeImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
            <div class="group relative overflow-hidden rounded-[1.75rem] shadow-[0_4px_20px_rgb(0,0,0,0.03)] border border-rose-100/60 aspect-square bg-gradient-to-br from-rose-50 to-amber-50 flex items-center justify-center hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] hover:-translate-y-0.5 transition-all duration-300 cursor-pointer">
                <span class="text-5xl opacity-20 group-hover:opacity-30 transition-opacity duration-300 select-none"><?php echo e($img['emoji']); ?></span>
                ...
                <div class="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <div class="absolute bottom-0 left-0 right-0 p-4">
                        <p class="text-white font-bold text-sm"><?php echo e($img['title']); ?></p>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/home.blade.php ENDPATH**/ ?>