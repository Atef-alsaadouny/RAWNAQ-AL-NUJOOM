<?php $__env->startSection('page-title', __('Add Employee')); ?>

<?php $__env->startSection('content'); ?>

<form method="POST" action="<?php echo e(route('admin.employees.store')); ?>" class="max-w-2xl bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
    <?php echo csrf_field(); ?>

    <div class="bg-gradient-to-l from-amber-50 to-white px-6 py-4 border-b border-gray-100">
        <h2 class="text-lg font-bold text-gray-800"><?php echo e(__('Add New Employee')); ?></h2>
    </div>
    ...
    <div class="p-6">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                <label class="block text-gray-600 text-sm font-medium mb-1.5"><?php echo e(__('Password')); ?> <span class="text-red-500">*</span></label>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/employees/create.blade.php ENDPATH**/ ?>