<?php $__env->startSection('page-title', __('Edit Service')); ?>
...
<div class="max-w-2xl mx-auto bg-white/90 backdrop-blur-sm rounded-[2.5rem] shadow-xl shadow-rose-200/40 border border-rose-100/50 overflow-hidden">
    <div class="bg-gradient-to-l from-rose-50 to-white px-6 py-5 border-b border-rose-100">
        <h2 class="text-xl font-bold text-gray-800"><?php echo e(__('Edit Service')); ?>: <?php echo e($service->name); ?></h2>
    </div>
    <form method="POST" action="<?php echo e(route('admin.services.update', $service)); ?>" class="p-6 md:p-8">
        <?php echo csrf_field(); ?>
        ...
        <div class="mb-5">
            ...
            <input type="text" name="name_ar" required value="<?php echo e(old('name_ar', $service->name_ar)); ?>"
        ...
        <div class="mb-5">
            ...
            <input type="text" name="name_en" value="<?php echo e(old('name_en', $service->name_en)); ?>"
                class="w-full rounded-xl px-4 py-3 text-sm border-2 border-gray-100 focus:ring-0 focus:border-rose-300 focus:bg-rose-50/20 transition-all duration-200">
        </div>
        ...
        <div class="mb-5">
            ...
            <select name="category" required class="w-full rounded-xl px-4 py-3 text-sm border-2 border-gray-100 focus:ring-0 focus:border-rose-300 focus:bg-rose-50/20 transition-all duration-200">
                ...
                <option value="شعر" <?php echo e(old('category', $service->category) == 'شعر' ? 'selected' : ''); ?>><?php echo e(__('Hair')); ?></option>
                <option value="مكياج" <?php echo e(old('category', $service->category) == 'مكياج' ? 'selected' : ''); ?>><?php echo e(__('Makeup')); ?></option>
                <option value="بشرة" <?php echo e(old('category', $service->category) == 'بشرة' ? 'selected' : ''); ?>><?php echo e(__('Skin')); ?></option>
                <option value="أظافر" <?php echo e(old('category', $service->category) == 'أظافر' ? 'selected' : ''); ?>><?php echo e(__('Nails')); ?></option>
                <option value="مساج" <?php echo e(old('category', $service->category) == 'مساج' ? 'selected' : ''); ?>><?php echo e(__('Massage')); ?></option>
                <option value="عناية" <?php echo e(old('category', $service->category) == 'عناية' ? 'selected' : ''); ?>><?php echo e(__('Care')); ?></option>
                <option value="أخرى" <?php echo e(old('category', $service->category) == 'أخرى' ? 'selected' : ''); ?>><?php echo e(__('Other')); ?></option>
            </select>
        </div>

        <div class="mb-5">
            <label class="block text-gray-700 text-sm font-bold mb-2"><?php echo e(__('Description (arabic)')); ?></label>
            <textarea name="description_ar" rows="3" class="w-full rounded-xl px-4 py-3 text-sm border-2 border-gray-100 focus:ring-0 focus:border-rose-300 focus:bg-rose-50/20 transition-all duration-200 resize-none"><?php echo e(old('description_ar', $service->description_ar)); ?></textarea>
        </div>

        <div class="mb-5">
            <label class="block text-gray-700 text-sm font-bold mb-2"><?php echo e(__('Description (english)')); ?></label>
            <textarea name="description_en" rows="3" class="w-full rounded-xl px-4 py-3 text-sm border-2 border-gray-100 focus:ring-0 focus:border-rose-300 focus:bg-rose-50/20 transition-all duration-200 resize-none"><?php echo e(old('description_en', $service->description_en)); ?></textarea>
        </div>
        ...
        <div class="grid grid-cols-2 gap-5 mb-5">
            <div>
                ...
                <div class="relative">
                    <input type="number" step="0.001" name="price" required value="<?php echo e(old('price', $service->price)); ?>"
            ...
            <div>
                ...
                <div class="relative">
                    <input type="number" name="duration_minutes" required value="<?php echo e(old('duration_minutes', $service->duration_minutes)); ?>"
                        class="w-full rounded-xl px-4 py-3 text-sm border-2 border-gray-100 focus:ring-0 focus:border-rose-300 focus:bg-rose-50/20 transition-all duration-200 pr-14">
        ...
        <div class="mb-4">
            <label class="flex items-center gap-2.5 cursor-pointer">
                <input type="checkbox" name="is_active" value="1" <?php echo e($service->is_active ? 'checked' : ''); ?>

                    class="w-5 h-5 rounded-lg border-2 border-gray-200 text-rose-600 focus:ring-rose-500/20 transition-all">
                <span class="text-sm font-bold text-gray-700"><?php echo e(__('Active')); ?></span>
            </label>
        </div>

        <div class="mb-6">
            <label class="block text-gray-700 text-sm font-bold mb-2"><?php echo e(__('Sort Order')); ?></label>
            <input type="number" name="sort_order" value="<?php echo e(old('sort_order', $service->sort_order)); ?>"
                class="w-full rounded-xl px-4 py-3 text-sm border-2 border-gray-100 focus:ring-0 focus:border-rose-300 focus:bg-rose-50/20 transition-all duration-200">
        </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/services/edit.blade.php ENDPATH**/ ?>