<?php $__env->startSection('title', __('site_name') . ' — ' . __('FAQ')); ?>
<?php $__env->startSection('meta_description', __('Answers to frequently asked questions about booking, cancellation, payment, and services at alnjoom — a ladies beauty salon in Kuwait.')); ?>
...
<div class="max-w-4xl mx-auto px-4">
    ...
    <div class="text-center mb-12">
        <div class="inline-flex items-center gap-2 bg-rose-100/60 text-rose-700 px-5 py-2 rounded-full text-sm font-medium mb-4">
            ...
            <?php echo e(__("We've answered your questions")); ?>

        </div>
        <h1 class="text-4xl font-bold text-gray-800 mb-3"><?php echo e(__('Frequently Asked Questions')); ?></h1>
    </div>

    
    <div class="flex flex-wrap justify-center gap-2 mb-10" id="filters">
        <button class="filter-btn active bg-rose-500 text-white px-5 py-2 rounded-full text-sm font-bold transition-all duration-200" data-filter="all"><?php echo e(__('All')); ?></button>
        <button class="filter-btn bg-rose-50 text-rose-700 px-5 py-2 rounded-full text-sm font-bold hover:bg-rose-100 transition-all duration-200" data-filter="booking"><?php echo e(__('Booking')); ?></button>
        <button class="filter-btn bg-rose-50 text-rose-700 px-5 py-2 rounded-full text-sm font-bold hover:bg-rose-100 transition-all duration-200" data-filter="cancel"><?php echo e(__('Cancellation')); ?></button>
        <button class="filter-btn bg-rose-50 text-rose-700 px-5 py-2 rounded-full text-sm font-bold hover:bg-rose-100 transition-all duration-200" data-filter="services"><?php echo e(__('Services')); ?></button>
        <button class="filter-btn bg-rose-50 text-rose-700 px-5 py-2 rounded-full text-sm font-bold hover:bg-rose-100 transition-all duration-200" data-filter="payment"><?php echo e(__('Payment')); ?></button>
    </div>
    ...
    <div class="space-y-4 mb-16" id="faqContainer">
        ...
        <div class="faq-item bg-white rounded-2xl shadow-sm border border-rose-100/60 overflow-hidden transition-all duration-300 hover:shadow-md" data-category="<?php echo e($faq['cat']); ?>">
            <button class="faq-btn w-full flex items-center justify-between p-6 text-right hover:bg-rose-50/30 transition-colors duration-200" aria-expanded="false">
                <span class="font-bold text-gray-800 text-[15px]"><?php echo e($faq['q']); ?></span>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/faq.blade.php ENDPATH**/ ?>