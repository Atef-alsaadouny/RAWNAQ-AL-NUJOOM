...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="text-center mb-7">
        <h1 class="text-2xl font-bold text-gray-800"><?php echo e(__('Welcome Back')); ?></h1>
        <p class="text-gray-500 mt-1.5"><?php echo e(__('Login To View Bookings')); ?></p>
    </div>
...
<?php endif; ?>
    ...
    <form method="POST" action="<?php echo e(route('login')); ?>" id="loginForm">
        ...
        <div>
            <label for="login" class="<?php echo e($labelClass); ?>"><?php echo e(__('Phone Or Email')); ?> <span class="text-red-500">*</span></label>
            <div class="relative">
                ...
                <input id="login" class="<?php echo e($inputClass); ?> ps-10" type="text" name="login" value="<?php echo e(old('login')); ?>" required autofocus autocomplete="username" placeholder="6xxxxxxx" />
            </div>
            <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-error','data' => ['messages' => $errors->get('login'),'class' => 'mt-1.5']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['messages' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->get('login')),'class' => 'mt-1.5']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
        ...
        <div class="mt-5">
            <label for="password" class="<?php echo e($labelClass); ?>"><?php echo e(__('Password')); ?> <span class="text-red-500">*</span></label>
            <div class="relative">
                <div class="<?php echo e($iconClass); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <input id="password" class="<?php echo e($inputClass); ?> ps-10 pe-12" type="password" name="password" required autocomplete="current-password" placeholder="••••••••" />
...
<?php endif; ?>
        ...
        <div class="flex items-center justify-between mt-6">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Route::has('password.request')): ?>
                <a class="text-sm text-rose-600 hover:text-rose-700 hover:underline" href="<?php echo e(route('password.request')); ?>">
        ...
        <div class="mt-8">
            <button type="submit" id="loginButton" class="w-full inline-flex items-center justify-center px-6 py-3 bg-gradient-to-l from-rose-500 to-rose-600 border border-transparent rounded-xl font-semibold text-[15px] text-white shadow-md shadow-rose-200 hover:from-rose-600 hover:to-rose-700 focus:outline-none focus:ring-2 focus:ring-rose-400 focus:ring-offset-2 transition-all duration-200">
                <span id="buttonText"><?php echo e(__('Log In')); ?></span>
        ...
        <div class="text-center mt-6">
            <p class="text-sm text-gray-500">
                ...
                <a href="<?php echo e(route('register')); ?>" class="text-rose-600 hover:text-rose-700 hover:underline font-medium"><?php echo e(__('Register Now')); ?></a>
            </p>
        </div>
    </form>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            form.addEventListener('submit', function () {
                ...
                btnText.textContent = '<?php echo e(__('Loading')); ?>';
