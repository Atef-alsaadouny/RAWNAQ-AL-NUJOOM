...
<div class="max-w-2xl mx-auto px-4 py-6">
    <div class="text-center mb-8">
        <h1 class="text-3xl font-black text-gray-800"><?php echo e(__('Edit Booking')); ?></h1>
        <div class="mt-2 text-5xl font-black tracking-widest text-transparent bg-clip-text bg-gradient-to-l from-amber-500 to-rose-600"><?php echo e($appointment->ticket_number); ?></div>
    </div>

    <div class="bg-white/90 backdrop-blur-sm rounded-[2.5rem] shadow-xl shadow-rose-200/40 border border-rose-100/50 p-5 md:p-10">
        <form method="POST" action="<?php echo e(route('booking.guest.update', $appointment)); ?>" id="editForm">
            <?php echo csrf_field(); ?>
            ...
            <div class="mb-8 bg-gradient-to-l from-rose-50 to-amber-50/50 border border-rose-100/50 rounded-2xl px-5 py-4 text-sm text-gray-600 flex items-center justify-between">
                <span class="font-bold"><?php echo e($appointment->customer_name); ?></span>
            ...
            <div class="mb-8">
                ...
                <p class="text-sm text-gray-400 mb-4 mr-7"><?php echo e(__('You can change selected packages — new package services will replace the old ones')); ?></p>
                <div class="space-y-3">
                    ...
                    <label class="package-card border-2 rounded-2xl p-5 cursor-pointer transition-all duration-200 flex items-center gap-4 <?php echo e(in_array($package->id, $selectedPackageIds) ? 'border-rose-300 bg-rose-50/40 shadow-sm' : 'border-gray-100 bg-white hover:border-rose-200 hover:shadow-sm'); ?>">
                        <input type="checkbox" name="package_ids[]" value="<?php echo e($package->id); ?>" class="package-checkbox w-5 h-5 text-rose-500 rounded"
                            <?php echo e(in_array($package->id, $selectedPackageIds) ? 'checked' : ''); ?>
            ...
            <div class="mb-8">
                <div class="flex items-center gap-2 mb-1">
                    ...
                    <label class="block text-gray-700 font-bold text-sm" id="servicesLabel">
                        <?php echo e(!empty($selectedPackageIds) ? __('Extra services for package') : __('Services')); ?>

                    </label>
                </div>

                <div id="packageServicesInfo" class="<?php echo e(!empty($selectedPackageIds) ? '' : 'hidden'); ?> bg-rose-50/70 border border-rose-200/60 rounded-2xl p-5 mb-4 mt-3">
                    ...
                    <div class="flex flex-wrap gap-2" id="packageServicesTags">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $appointment->packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pkg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            ...
                            <span class="bg-rose-100 text-rose-700 text-sm px-3 py-1.5 rounded-lg">✅ <?php echo e($ps->name); ?></span>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                    </div>
                </div>
                ...
                <div class="space-y-2 mt-3" id="servicesContainer">
                    ...
                    ?>
                    <label class="service-item border-2 rounded-2xl p-4 cursor-pointer transition-all duration-200 flex justify-between items-center gap-4 <?php echo e($isPackage ? 'border-rose-200 bg-rose-50/30' : 'border-gray-100 bg-white hover:border-rose-200 hover:shadow-sm'); ?>"
                        ...
                        <div class="flex items-center gap-3 min-w-0">
                            <input type="checkbox" name="service_ids[]" value="<?php echo e($service->id); ?>" class="service-checkbox w-5 h-5 text-rose-500 rounded shrink-0"
                                <?php echo e($isPackage ? 'checked disabled' : ''); ?>

                                <?php echo e(!$isPackage && $hasService ? 'checked' : ''); ?>>
                            <div>
                                <span class="font-bold <?php echo e($isPackage ? 'text-rose-600' : 'text-gray-800'); ?>"><?php echo e($service->name); ?></span>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                <div>
                    ...
                    <input type="date" name="appointment_date" value="<?php echo e($appointment->appointment_date->format('Y-m-d')); ?>" required min="<?php echo e(now()->format('Y-m-d')); ?>"
            ...
            <div class="mb-6">
                <div class="flex items-center gap-2 mb-1">
                    ...
                    <label class="block text-gray-700 font-bold text-sm"><?php echo e(__('Employee')); ?> <span class="text-gray-400 font-normal"><?php echo e(__('(Optional)')); ?></span></label>
                </div>
                <p class="text-sm text-gray-400 mb-3 mr-7"><?php echo e(__('You can change the selected employee')); ?></p>
                <div class="flex flex-wrap gap-2.5" id="employeeContainer">
                    <label class="employee-option rounded-2xl px-5 py-3 cursor-pointer transition-all duration-200 text-sm font-medium border-2 flex items-center gap-2.5 <?php echo e(!$appointment->employee_id ? 'border-rose-300 bg-rose-50/70 text-rose-700 shadow-sm' : 'border-gray-100 bg-white text-gray-500 hover:border-rose-200 hover:text-rose-600'); ?>">
                        <input type="radio" name="employee_id" value="" class="employee-radio hidden" <?php echo e(!$appointment->employee_id ? 'checked' : ''); ?> onchange="updateEmployeeSelection()">
                    ...
                    <label class="employee-option rounded-2xl px-5 py-3 cursor-pointer transition-all duration-200 text-sm font-medium border-2 flex items-center gap-2.5 <?php echo e($appointment->employee_id == $emp->id ? 'border-rose-300 bg-rose-50/70 text-rose-700 shadow-sm' : 'border-gray-100 bg-white text-gray-500 hover:border-rose-200 hover:text-rose-600'); ?>">
                        <input type="radio" name="employee_id" value="<?php echo e($emp->id); ?>" class="employee-radio hidden" <?php echo e($appointment->employee_id == $emp->id ? 'checked' : ''); ?> onchange="updateEmployeeSelection()">
                        <?php echo e($emp->name); ?>
            ...
            <div class="mb-6">
                <label class="block text-gray-700 font-bold text-sm mb-2"><?php echo e(__('Notes')); ?></label>
                <textarea name="notes" rows="3" class="w-full border-2 border-gray-100 rounded-2xl px-5 py-3.5 focus:ring-0 focus:border-rose-300 focus:bg-rose-50/20 transition-all duration-200 resize-none"><?php echo e($appointment->notes); ?></textarea>
            </div>
            ...
            <div id="priceSummary" class="hidden bg-gradient-to-br from-amber-50 to-rose-50/50 border-2 border-amber-200/40 rounded-2xl p-6 mb-6 space-y-3">
                ...
                <div class="border-t border-amber-200/40 pt-3 flex justify-between items-center">
                    ...
                    <span class="text-2xl font-extrabold text-amber-700" id="summaryTotal"><?php echo e(formatCurrency(0)); ?></span>
                </div>
            </div>

            <div class="flex gap-3">
                <a href="<?php echo e(route('track')); ?>"
                   class="flex-1 block text-center bg-gray-100 text-gray-700 py-4 rounded-2xl font-bold hover:bg-gray-200 hover:-translate-y-0.5 active:translate-y-0 transition-all duration-200"><?php echo e(__('Back')); ?></a>
        ...
        <div class="mt-6 pt-6 border-t border-gray-100">
            ...
            <div id="cancelBoxEdit" class="hidden mt-3 p-5 bg-red-50/70 rounded-2xl border border-red-200">
                <form method="POST" action="<?php echo e(route('booking.guest.cancel', $appointment)); ?>" id="cancelFormEdit">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('DELETE'); ?>
                    <input type="hidden" name="phone" value="<?php echo e($phone); ?>">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request('token')): ?><input type="hidden" name="token" value="<?php echo e(request('token')); ?>"><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <textarea name="cancel_reason" id="cancelReasonEdit" rows="2" class="w-full border-2 border-red-200 rounded-xl px-4 py-3 text-sm focus:ring-0 focus:border-red-400 focus:bg-red-50/50 transition-all duration-200 resize-none" placeholder="<?php echo e(__('Is there a reason for cancellation?')); ?>"></textarea>
                    <div class="flex gap-3 mt-3">
                        <button type="button" onclick="confirmCancelEdit()" class="flex-1 bg-red-600 text-white py-2.5 rounded-xl font-bold hover:bg-red-700 transition text-sm"><?php echo e(__('Confirm Cancellation')); ?></button>
                        <button type="button" onclick="document.getElementById('cancelBoxEdit').classList.add('hidden')" class="flex-1 bg-emerald-500 text-white py-2.5 rounded-xl font-bold hover:bg-emerald-600 transition text-sm"><?php echo e(__('Undo')); ?></button>
                    </div>
                </form>
            </div>
            <script>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/customer/guest-edit.blade.php ENDPATH**/ ?>