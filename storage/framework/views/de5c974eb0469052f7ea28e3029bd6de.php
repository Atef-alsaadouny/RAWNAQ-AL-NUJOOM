                                                ...
                                                <td style="padding:10px 0;border-top:1px solid #fee2e2;">
                                                    <table width="100%">
                                                        <tr>
                                                            ...
                                                            <td style="font-weight:700;color:#1f2937;font-size:15px;"><?php echo e($data['name']); ?></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
                                                ...
                                                <td style="padding:10px 0;border-top:1px solid #fee2e2;">
                                                    <table width="100%">
                                                        <tr>
                                                            ...
                                                            <td style="font-weight:600;color:#1f2937;font-size:14px;direction:ltr;unicode-bidi:embed;">+965 <?php echo e($data['phone'] ?: '—'); ?></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
                                                    ...
                                                    <table width="100%">
                                                        <tr>
                                                            ...
                                                            <td style="font-weight:600;color:#1f2937;font-size:14px;direction:ltr;unicode-bidi:embed;">
                                                                <a href="mailto:<?php echo e($data['email']); ?>" style="color:#e11d48;text-decoration:none;font-weight:600;"><?php echo e($data['email'] ?: '—'); ?></a>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td style="background:#f9fafb;border-radius:12px;padding:20px;">
                                        <div style="color:#374151;font-size:14px;line-height:1.9;white-space:pre-wrap;"><?php echo e($data['message']); ?></div>
                                    </td>
                                </tr>
                            </table>
...
<?php /**PATH /var/www/html/resources/views/emails/contact-form.blade.php ENDPATH**/ ?>