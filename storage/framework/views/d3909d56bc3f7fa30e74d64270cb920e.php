                            ...
                            <table cellpadding="0" cellspacing="0" style="width:250px;height:250px;border-radius:50%;background:#ffffff;box-shadow:0 8px 24px rgba(0,0,0,0.10);margin-bottom:-125px;">
                                <tr>
                                    <td align="center" valign="middle" style="height:250px;padding:37px;">
                                        <img src="<?php echo e($logoEmbedded); ?>" alt="رونق النجوم" style="width:100%;height:auto;display:block;">
                                    </td>
                                </tr>
                            </table>
                        </td>
                                                ...
                                                <td style="padding:10px 0;border-top:1px solid #fee2e2;">
                                                    <table width="100%">
                                                        <tr>
                                                            ...
                                                            <td style="font-weight:600;color:#1f2937;font-size:14px;"><?php echo e($appointment->customer_name); ?></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
                                                ...
                                                <td style="padding:10px 0;border-top:1px solid #fee2e2;">
                                                    <table width="100%">
                                                        <tr>
                                                            ...
                                                            <td style="font-weight:600;color:#1f2937;font-size:14px;direction:ltr;unicode-bidi:embed;">+965 <?php echo e($appointment->customer_phone); ?></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
                                                    ...
                                                    <table width="100%">
                                                        <tr>
                                                            ...
                                                            <td style="font-weight:600;color:#1f2937;font-size:14px;direction:ltr;unicode-bidi:embed;">
                                                                <a href="mailto:<?php echo e(config('mail.from.address')); ?>" style="color:#e11d48;text-decoration:none;font-weight:600;"><?php echo e(config('mail.from.address')); ?></a>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                    ...
                                    <td style="padding:10px 0;border-bottom:1px solid #f3f4f6;">
                                        <table width="100%">
                                            <tr>
                                                ...
                                                <td style="font-weight:600;color:#1f2937;font-size:14px;"><?php echo e($appointment->appointment_date->format('Y/m/d')); ?></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                    ...
                                    <td style="padding:10px 0;border-bottom:1px solid #f3f4f6;">
                                        <table width="100%">
                                            <tr>
                                                ...
                                                <td style="font-weight:600;color:#1f2937;font-size:14px;"><?php echo e($appointment->shift === Appointment::SHIFT_MORNING ? 'الفترة الصباحية' : 'الفترة المسائية'); ?></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                    ...
                                    <td style="padding:10px 0;border-bottom:1px solid #f3f4f6;">
                                        <table width="100%">
                                            <tr>
                                                ...
                                                <td style="font-weight:600;color:#1f2937;font-size:14px;"><?php echo e($appointment->display_services); ?></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                        ...
                                        <table width="100%">
                                            <tr>
                                                ...
                                                <td style="font-weight:700;color:#e11d48;font-size:14px;">
                                                    <?php echo e($appointment->packages->pluck('name')->implode(' + ')); ?>
                                    ...
                                    <td style="padding:10px 0;">
                                        <table width="100%">
                                            <tr>
                                                ...
                                                <td style="font-weight:600;color:#1f2937;font-size:14px;"><?php echo e($appointment->employee->name); ?></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
...
<?php /**PATH /var/www/html/resources/views/emails/booking-confirmation.blade.php ENDPATH**/ ?>