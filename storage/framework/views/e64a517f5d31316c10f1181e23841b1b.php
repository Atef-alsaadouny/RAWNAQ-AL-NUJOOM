...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="text-center mb-7">
        <h1 class="text-2xl font-bold text-gray-800"><?php echo e(__('Create New Account')); ?></h1>
        <p class="text-gray-500 mt-1.5"><?php echo e(__('Track Bookings Easily')); ?></p>
    </div>
    ...
    <form method="POST" action="<?php echo e(route('register')); ?>" id="registerForm">
        ...
        <div>
            <label for="name" class="<?php echo e($labelClass); ?>"><?php echo e(__('Name')); ?> <span class="text-red-500">*</span></label>
            <div class="relative">
                ...
                <input id="name" class="<?php echo e($inputClass); ?> ps-10" type="text" name="name" value="<?php echo e(old('name')); ?>" required autofocus placeholder="<?php echo e(__('Full Name')); ?>" />
            </div>
...
<?php endif; ?>
        ...
        <div class="mt-5">
            <label for="phone" class="<?php echo e($labelClass); ?>"><?php echo e(__('Phone Number')); ?> <span class="text-red-500">*</span></label>
            <div class="relative">
                <div class="<?php echo e($iconClass); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <input id="phone" class="<?php echo e($inputClass); ?> ps-10" type="text" name="phone" value="<?php echo e(old('phone')); ?>" required placeholder="6xxxxxxx" inputmode="numeric" />
            </div>
            <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-error','data' => ['messages' => $errors->get('phone'),'class' => 'mt-1.5']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-error'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['messages' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->get('phone')),'class' => 'mt-1.5']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
        ...
        <div class="mt-5">
            <label for="email" class="<?php echo e($labelClass); ?>"><?php echo e(__('Email')); ?> <span class="text-xs text-gray-400 font-normal">(<?php echo e(__('Optional')); ?>)</span></label>
            <div class="relative">
                <div class="<?php echo e($iconClass); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <input id="email" class="<?php echo e($inputClass); ?> ps-10" type="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="example@email.com" />
            </div>
            <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
...
<?php endif; ?>
        ...
        <div class="mt-5">
            ...
            <div class="relative">
                ...
                <input id="password" class="<?php echo e($inputClass); ?> ps-10 pe-12" type="password" name="password" required autocomplete="new-password" placeholder="••••••••" />
...
<?php endif; ?>
        ...
        <div class="mt-5">
            <label for="password_confirmation" class="<?php echo e($labelClass); ?>"><?php echo e(__('Confirm Password')); ?> <span class="text-red-500">*</span></label>
            <div class="relative">
                <div class="<?php echo e($iconClass); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/>
                ...
                <input id="password_confirmation" class="<?php echo e($inputClass); ?> ps-10 pe-12" type="password" name="password_confirmation" required autocomplete="new-password" placeholder="••••••••" />
...
<?php endif; ?>
        ...
        <div class="mt-8">
            <button type="submit" id="registerButton" class="w-full inline-flex items-center justify-center px-6 py-3 bg-gradient-to-l from-rose-500 to-rose-600 border border-transparent rounded-xl font-semibold text-[15px] text-white shadow-md shadow-rose-200 hover:from-rose-600 hover:to-rose-700 focus:outline-none focus:ring-2 focus:ring-rose-400 focus:ring-offset-2 transition-all duration-200">
                <span id="buttonText"><?php echo e(__('Register Now')); ?></span>
        ...
        <div class="text-center mt-6">
            <p class="text-sm text-gray-500">
                ...
                <a href="<?php echo e(route('login')); ?>" class="text-rose-600 hover:text-rose-700 hover:underline font-medium"><?php echo e(__('Log In')); ?></a>
            </p>
        </div>
    </form>
