<?php $__env->startSection('title', __('Payment Successful')); ?>
...
<div class="max-w-lg mx-auto px-4 py-6">
    <div class="bg-gradient-to-b from-emerald-50 via-white to-amber-50 rounded-[2.5rem] shadow-xl shadow-emerald-200/40 border border-emerald-100/50 p-5 md:p-10 text-center">
        ...
        <h1 class="text-2xl font-bold text-gray-800 mb-2"><?php echo e(__('Payment Successful')); ?></h1>
        <p class="text-gray-500 mb-2"><?php echo e(__('Ticket Number')); ?>: <strong class="text-emerald-600"><?php echo e($appointment->ticket_number); ?></strong></p>
        <p class="text-gray-400 text-sm mb-6"><?php echo e(__('Payment Received Amount')); ?> <strong class="text-emerald-600"><?php echo e(formatCurrency($appointment->total_price)); ?></strong></p>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/payment/success.blade.php ENDPATH**/ ?>